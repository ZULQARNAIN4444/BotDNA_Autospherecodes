...
${EXCEL_PATH}      B:/BotsDNA-AutosphereCode/xlsx_theautomation/challenge.xlsx
...
Fill Form With Excel Data
    ...
    ${config}    Evaluate    json.load(open(r'B:\\BotsDNA-AutosphereCode\\TestAutosphere\\config.json', 'r'))    json
