*** Settings ***
Library    Autosphere.Browser        # Library used to automate browser actions (open browser, get text, click, etc.)
Library    Collections            # Library used for list and dictionary operations
Library    Autosphere.Excel.Files        # Library used to create and write Excel files
