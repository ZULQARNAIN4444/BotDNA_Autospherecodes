*** Settings ***
Library    Autosphere.Browser        # Library for browser automation (open browser, click elements, get text, etc.)
...
Library    loan_excel_helper.py        # Custom Python library that contains helper functions for Excel and file processing
